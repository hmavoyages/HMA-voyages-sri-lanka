// src/pages/ItineraryKandyDay.jsx
...
const heroImages = [
  "https://via.placeholder.com/1600x900?text=Kandy+Lake+and+City",
  "https://via.placeholder.com/1600x900?text=Temple+of+the+Tooth",
  "https://via.placeholder.com/1600x900?text=Peradeniya+Botanical+Gardens",
  "https://via.placeholder.com/1600x900?text=Spice+Garden+%2F+Gems",
];
...
const day = (n, title, stay, bullets, drive = "", images = []) => ({
  ...
  drive,
  bullets,
  images: images.length ? images : [ph(`Kandy Day ${n}`)],
});
...
const days = [
  day(
    ...
    [
      ...
      "Herbal & Spice Garden tour.",
      "Peradeniya Botanical Gardens.",
      "Gem Museum visit.",
      "Temple of the Sacred Tooth Relic.",
      "End the day with a lovely walk around Kandy Lake.",
      "Travel back to your hotel.",
      "Drop off to your hotel.",
    ],
    "Hotel ↔ Kegalle / Peradeniya / Kandy City",
    [
      ph("Millennium Elephant Foundation"),
      ph("Spice Garden"),
      ph("Peradeniya Botanical Gardens"),
      ph("Gem Museum"),
      ph("Temple of the Tooth"),
      ph("Kandy Lake Walk"),
    ]
  ),
];
...
const WA_NUMBER = "+94763011488"; // change if needed

export default function ItineraryKandyDay() {
        ...
        >
          ...
          >
            <Chip
              ...
              label="Kandy Day Tour • Private & Customizable"
              sx={{
                mb: { xs: 1, md: 2 },
            ...
            <Typography variant={isXs ? "body1" : "h6"} color="#f5f5f5" sx={{ mt: 0.75, pr: { md: 6 } }}>
              “Uncover the cultural treasures of Kandy.”
            </Typography>
            <Stack direction="row" spacing={1.25} sx={{ mt: 2, flexWrap: "wrap" }}>
              <Chip icon={<AccessTimeIcon />} label="Activity Duration: ~14 hours" sx={{ bgcolor: "rgba(255,255,255,0.9)" }} />
              <Button
                variant="contained"
                color="warning"
              ...
              <Button
                ...
                href={`https://wa.me/94763011488?text=I%27m%20interested%20in%20the%20Kandy%20Day%20Tour`}
                target="_blank"
                rel="noreferrer"
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 6 } }}>
        <Grid container spacing={{ xs: 1.5, md: 2 }}>
          {[
            ...
            { icon: <ScheduleIcon />, text: "Full-day cultural highlights (~14h)" },
            { icon: <MapIcon />, text: "Elephant foundation, gardens, gems & Tooth Relic" },
          ].map((h, i) => (
        ...
        <Container maxWidth="lg">
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Stack direction="row" spacing={1.25} alignItems="center" flexWrap="wrap" sx={{ width: "100%" }}>
                    ...
                    <Stack direction="row" spacing={1} alignItems="center" sx={{ ml: "auto" }}>
                      <Chip icon={<DirectionsCarIcon />} label={d.drive} size="small" sx={{ maxWidth: { xs: 280, sm: "none" } }} />
                      <Chip icon={<AccessTimeIcon />} label="~14 hours" size="small" />
                    </Stack>
                  </Stack>
                </AccordionSummary>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25} sx={{ mt: { xs: 2.5, md: 4 } }}>
            <Button
              ...
              size="large"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=I%27d%20like%20to%20book%20the%20Kandy%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
        ...
        <Container maxWidth="lg" sx={{ py: 1 }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Button
              ...
              color="success"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=Hi!%20I%27m%20interested%20in%20the%20Kandy%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
