// src/pages/ItineraryColomboDay.jsx
...
const heroImages = [
  "https://via.placeholder.com/1600x900?text=Colombo+Skyline",
  "https://via.placeholder.com/1600x900?text=Independence+Square",
  "https://via.placeholder.com/1600x900?text=Gangaramaya+Temple",
  "https://via.placeholder.com/1600x900?text=Galle+Face+Green",
];
...
const day = (n, title, stay, bullets, drive = "", images = []) => ({
  ...
  drive,
  bullets,
  images: images.length ? images : [ph(`Colombo Day ${n}`)],
});
...
const days = [
  day(
    ...
    [
      ...
      "Independence Square, National Museum, Gangaramaya Temple, Pettah Market.",
      "Lunch in Colombo.",
      "Seaside walk at Galle Face Green.",
      "Travel back to hotel.",
      "Drop off to your hotel.",
    ],
    "Hotel ↔ Colombo City",
    [
      ph("Independence Square"),
      ph("National Museum"),
      ph("Gangaramaya Temple"),
      ph("Pettah Market"),
      ph("Galle Face Green"),
    ]
  ),
...
const WA_NUMBER = "+94763011488"; // update if you want

export default function ItineraryColomboDay() {
  ...
  return (
    <Box sx={{ bgcolor: "background.default", color: "text.primary" }}>
      ...
      >
        ...
        >
          <Box component={motion.div} {...fadeIn} sx={{ p: { xs: 1.5, sm: 2.5, md: 4 }, maxWidth: { xs: "100%", md: 760 }, backdropFilter: "blur(2px)" }}>
            <Chip
              icon={<FlightTakeoffIcon />}
              label="Colombo Day Tour • Private & Customizable"
              sx={{
                mb: { xs: 1, md: 2 },
            ...
            <Typography variant={isXs ? "body1" : "h6"} color="#f5f5f5" sx={{ mt: 0.75, pr: { md: 6 } }}>
              “Discover the dynamic heart of Sri Lanka in Colombo.”
            </Typography>
            <Stack direction="row" spacing={1.25} sx={{ mt: 2, flexWrap: "wrap" }}>
              <Chip
                icon={<AccessTimeIcon />}
                label="Activity Duration: ~5 hours"
              ...
              <Button
                ...
                href={`https://wa.me/94763011488?text=I%27m%20interested%20in%20the%20Colombo%20Day%20Tour`}
                target="_blank"
                rel="noreferrer"
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 6 } }}>
        <Grid container spacing={{ xs: 1.5, md: 2 }}>
          {[
            ...
            { icon: <ScheduleIcon />, text: "Efficient 5-hour loop with smart stops" },
            { icon: <MapIcon />, text: "Museum, temple, market & seaside walk" },
          ].map((h, i) => (
        ...
        <Container maxWidth="lg">
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Stack direction="row" spacing={1.25} alignItems="center" flexWrap="wrap" sx={{ width: "100%" }}>
                    ...
                    <Stack direction="row" spacing={1} alignItems="center" sx={{ ml: "auto" }}>
                      <Chip icon={<DirectionsCarIcon />} label={d.drive} size="small" sx={{ maxWidth: { xs: 220, sm: "none" } }} />
                      <Chip icon={<AccessTimeIcon />} label="~5 hours" size="small" />
                    </Stack>
                  </Stack>
                </AccordionSummary>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25} sx={{ mt: { xs: 2.5, md: 4 } }}>
            <Button
              ...
              size="large"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=I%27d%20like%20to%20book%20the%20Colombo%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
        ...
        <Container maxWidth="lg" sx={{ py: 1 }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Button
              ...
              color="success"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=Hi!%20I%27m%20interested%20in%20the%20Colombo%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
