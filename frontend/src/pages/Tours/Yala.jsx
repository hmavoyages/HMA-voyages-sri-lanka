// src/pages/ItineraryYalaDay.jsx
...
const day = (n, title, stay, bullets, drive = "", images = []) => ({
  ...
  drive,
  bullets,
  images: images.length ? images : [ph(`Yala Day ${n}`)],
});

const days = [
  day(
    1,
    "Yala Safari Highlights",
    "—",
    [
      "Pick up from your hotel.",
      "Lunch at Tissamaharama.",
      "Half-day afternoon game drive at Yala National Park.",
      "Travel back to your hotel.",
      "Drop off to your hotel.",
    ],
    "Hotel ↔ Tissamaharama / Yala National Park",
    [
      ph("Tissamaharama Lunch Stop"),
      ph("Yala Safari Jeep"),
      ph("Yala Wildlife (Leopard/Elephant)"),
      ph("Yala Landscape at Sunset"),
    ]
  ),
];
...
export default function ItineraryYalaDay() {
      ...
      >
        ...
        >
          <Box
            ...
            {...fadeIn}
            sx={{ p: { xs: 1.5, sm: 2.5, md: 4 }, maxWidth: { xs: "100%", md: 760 }, backdropFilter: "blur(2px)" }}
          >
            <Chip
              icon={<FlightTakeoffIcon />}
              label="Day Tour to Yala National Park • Private & Customizable"
              sx={{
                mb: { xs: 1, md: 2 },
            ...
            <Typography variant={isXs ? "body1" : "h6"} color="#f5f5f5" sx={{ mt: 0.75, pr: { md: 6 } }}>
              “Embark on an exhilarating safari in Yala National Park.”
            </Typography>
            <Stack direction="row" spacing={1.25} sx={{ mt: 2, flexWrap: "wrap" }}>
              <Chip icon={<AccessTimeIcon />} label="Activity Duration: ~16 hours" sx={{ bgcolor: "rgba(255,255,255,0.9)" }} />
              <Button
                variant="contained"
                color="warning"
              ...
              <Button
                ...
                href={`https://wa.me/94763011488?text=I%27m%20interested%20in%20the%20Yala%20National%20Park%20Day%20Tour`}
                target="_blank"
                rel="noreferrer"
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 6 } }}>
        <Grid container spacing={{ xs: 1.5, md: 2 }}>
          {[
            ...
            { icon: <ScheduleIcon />, text: "Full-day safari focus (~16h)" },
            { icon: <MapIcon />, text: "Tissamaharama lunch & Yala game drive" },
          ].map((h, i) => (
        ...
        <Container maxWidth="lg">
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Stack direction="row" spacing={1.25} alignItems="center" flexWrap="wrap" sx={{ width: "100%" }}>
                    ...
                    <Stack direction="row" spacing={1} alignItems="center" sx={{ ml: "auto" }}>
                      ...
                      <Chip icon={<AccessTimeIcon />} label="~16 hours" size="small" />
                    </Stack>
                  </Stack>
                </AccordionSummary>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25} sx={{ mt: { xs: 2.5, md: 4 } }}>
            <Button
              ...
              size="large"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=I%27d%20like%20to%20book%20the%20Yala%20National%20Park%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
        ...
        <Container maxWidth="lg" sx={{ py: 1 }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Button
              ...
              color="success"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=Hi!%20I%27m%20interested%20in%20the%20Yala%20National%20Park%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
