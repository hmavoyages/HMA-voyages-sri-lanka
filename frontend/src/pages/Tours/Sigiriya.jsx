// src/pages/ItinerarySigiriyaDambullaDay.jsx
...
const heroImages = [
  "https://via.placeholder.com/1600x900?text=Sigiriya+Lion+Rock",
  "https://via.placeholder.com/1600x900?text=Dambulla+Royal+Cave+Temple",
  "https://via.placeholder.com/1600x900?text=Village+Tour+%26+Lunch",
  "https://via.placeholder.com/1600x900?text=Kurunegala+City+Breakfast",
];
...
const day = (n, title, stay, bullets, drive = "", images = []) => ({
  ...
  drive,
  bullets,
  images: images.length ? images : [ph(`Sigiriya Dambulla Day ${n}`)],
});

const days = [
  day(
    1,
    "Sigiriya & Dambulla Highlights",
    "—",
    [
      "Pick up from your hotel.",
      "Breakfast stop at Kurunegala city.",
      "Visit Dambulla Royal Cave Temple.",
      "Experience a village tour with Sri Lankan rice & curry lunch plus a cooking demonstration.",
      "Climb the iconic Sigiriya Lion Rock.",
      "Travel back to your hotel.",
      "Drop off to your hotel.",
    ],
    "Hotel ↔ Dambulla / Sigiriya (via Kurunegala)",
    [
      ph("Kurunegala Breakfast Stop"),
      ph("Dambulla Royal Cave Temple"),
      ph("Village Tour + Cooking Demo"),
      ph("Sigiriya Lion Rock"),
    ]
  ),
];
...
export default function ItinerarySigiriyaDambullaDay() {
        ...
        >
          ...
          >
            <Chip
              ...
              label="Sigiriya & Dambulla Day Tour • Private & Customizable"
              sx={{
                mb: { xs: 1, md: 2 },
            ...
            <Typography variant={isXs ? "body1" : "h6"} color="#f5f5f5" sx={{ mt: 0.75, pr: { md: 6 } }}>
              “Marvel at the ancient wonders of Sigiriya and Dambulla.”
            </Typography>
            <Stack direction="row" spacing={1.25} sx={{ mt: 2, flexWrap: "wrap" }}>
              ...
              <Button
                ...
                href={`https://wa.me/94763011488?text=I%27m%20interested%20in%20the%20Sigiriya%20%26%20Dambulla%20Day%20Tour`}
                target="_blank"
                rel="noreferrer"
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 6 } }}>
        <Grid container spacing={{ xs: 1.5, md: 2 }}>
          {[
            ...
            { icon: <ScheduleIcon />, text: "Full-day heritage & village experience (~15h)" },
            { icon: <MapIcon />, text: "Dambulla Caves, village lunch & Sigiriya Rock" },
          ].map((h, i) => (
        ...
        <Stack spacing={{ xs: 1.25, md: 2 }}>
              ...
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Stack direction="row" spacing={1.25} alignItems="center" flexWrap="wrap" sx={{ width: "100%" }}>
                  ...
                  <Stack direction="row" spacing={1} alignItems="center" sx={{ ml: "auto" }}>
                    <Chip icon={<DirectionsCarIcon />} label={d.drive} size="small" sx={{ maxWidth: { xs: 300, sm: "none" } }} />
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25} sx={{ mt: { xs: 2.5, md: 4 } }}>
            <Button
              ...
              size="large"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=I%27d%20like%20to%20book%20the%20Sigiriya%20%26%20Dambulla%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
        ...
        <Container maxWidth="lg" sx={{ py: 1 }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Button
              ...
              color="success"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=Hi!%20I%27m%20interested%20in%20the%20Sigiriya%20%26%20Dambulla%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
