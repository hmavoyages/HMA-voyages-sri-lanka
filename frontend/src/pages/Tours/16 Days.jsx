...
// ===== HERO images (swap with your own direct links when ready) =====
const heroImages = [
...
const days = [
  ...
  day(
    ...
    "Wilpattu",
    [
      "After breakfast, drive to Wilpattu (~4 hours).",
      "Half-day game drive safari at Wilpattu National Park.",
    ],
    "Negombo → Wilpattu"
  ),
  day(
    3,
    "Anuradhapura • Mihintale • Sigiriya",
    "Sigiriya",
    [
      "After breakfast, visit Anuradhapura (~45 min).",
  ...
  day(
    9,
    "Ella Leisure • Nine Arches Bridge",
    "Ella",
    [
      "Leisure day in Ella.",
      "Walk to the famous Nine Arches Bridge.",
      "Stroll around Ella village.",
    ],
    "Around Ella"
  ),
  day(
    10,
    "Waterfalls & Buduruwagala • Yala",
    "Yala",
    [
      "After breakfast, drive to Yala (~2h 30m).",
      "Rawana Falls.",
  ...
  day(
    11,
    "Yala Safari • Down South",
    "Mirissa",
    [
      "Early morning half-day game drive at Yala National Park (~4h).",
      "Drive to Mirissa (~2h).",
  ...
  day(
    ...
    [
      ...
      "After lunch, walk on Galle Fort & city.",
    ],
    "Around Galle"
  ),
  day(
  ...
  day(
    ...
    [
      ...
      "Drop-off at the airport — End of tour.",
    ],
    "Hotel → Airport"
  ),
];
...
export default function ItinerarySL16() {
        ...
        >
          ...
          >
            <Chip
              ...
              label="16 Days / 15 Nights • Private & Customizable"
              sx={{
                mb: { xs: 1, md: 2 },
            ...
            <Typography variant={isXs ? "h4" : "h3"} fontWeight={800} color="#fff" sx={{ lineHeight: 1.15 }}>
              Sri Lanka Grand Circuit
            </Typography>
            <Typography variant={isXs ? "body1" : "h6"} color="#f5f5f5" sx={{ mt: 0.75, pr: { md: 6 } }}>
              Ancient capitals, wild safaris, misty tea hills, scenic trains, and golden beaches.
            </Typography>
            <Stack direction="row" spacing={1.25} sx={{ mt: 2 }}>
              ...
              <Button
                ...
                href={`https://wa.me/94763011488?text=I%27m%20interested%20in%20the%2016-day%20Sri%20Lanka%20Tour`}
                target="_blank"
                rel="noreferrer"
                sx={{
                  fontWeight: 700,
        ...
        <Container maxWidth="lg">
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25} sx={{ mt: { xs: 2.5, md: 4 } }}>
            <Button
              ...
              size="large"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=I%27d%20like%20to%20book%20the%2016-day%20Sri%20Lanka%20tour`}
              target="_blank"
              rel="noreferrer"
        ...
        <Container maxWidth="lg" sx={{ py: 1 }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Button
              ...
              color="success"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=Hi!%20I%27m%20interested%20in%20the%2016-day%20Sri%20Lanka%20itinerary`}
              target="_blank"
              rel="noreferrer"
              sx={{ fontWeight: 700, borderRadius: 2 }}
            >
