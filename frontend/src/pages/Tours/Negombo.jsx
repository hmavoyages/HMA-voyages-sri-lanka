// src/pages/ItineraryNegomboDay.jsx
...
// ===== HERO images (replace with your direct image links) =====
const heroImages = [
  "https://via.placeholder.com/1600x900?text=Negombo+Lagoon",
  "https://via.placeholder.com/1600x900?text=Negombo+Fish+Market",
  "https://via.placeholder.com/1600x900?text=Dutch+Canal",
  "https://via.placeholder.com/1600x900?text=Beach+Sunset",
];
...
const day = (n, title, stay, bullets, drive = "", images = []) => ({
  ...
  drive,
  bullets,
  images: images.length ? images : [ph(`Negombo Day ${n}`)],
});

const days = [
  day(
    1,
    "Negombo City & Lagoon Highlights",
    "—",
    [
      "Pick up from your hotel.",
      "Visit Buddhist temples, old churches, and the bustling fish market.",
      "Lunch in Negombo.",
      "Dutch Canal & Lagoon boat ride.",
...
export default function ItineraryNegomboDay() {
        ...
        >
          ...
          >
            <Chip
              ...
              label="Negombo Day Tour • Private & Customizable"
              sx={{
                mb: { xs: 1, md: 2 },
            ...
            <Typography variant={isXs ? "body1" : "h6"} color="#f5f5f5" sx={{ mt: 0.75, pr: { md: 6 } }}>
              “Explore the vibrant coastal city of Negombo.”
            </Typography>
            <Stack direction="row" spacing={1.25} sx={{ mt: 2, flexWrap: "wrap" }}>
              <Chip icon={<AccessTimeIcon />} label="Activity Duration: ~5 hours" sx={{ bgcolor: "rgba(255,255,255,0.9)" }} />
              <Button
                variant="contained"
                color="warning"
              ...
              <Button
                ...
                href={`https://wa.me/94763011488?text=I%27m%20interested%20in%20the%20Negombo%20Day%20Tour`}
                target="_blank"
                rel="noreferrer"
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 6 } }}>
        <Grid container spacing={{ xs: 1.5, md: 2 }}>
          {[
            ...
            { icon: <MapIcon />, text: "Temples, churches, fish market & lagoon boat ride" },
          ].map((h, i) => (
        ...
        <Container maxWidth="lg">
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={1.25} sx={{ mt: { xs: 2.5, md: 4 } }}>
            <Button
              ...
              size="large"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=I%27d%20like%20to%20book%20the%20Negombo%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
        ...
        <Container maxWidth="lg" sx={{ py: 1 }}>
          <Stack direction="row" spacing={1} alignItems="center">
            <Button
              ...
              color="success"
              startIcon={<WhatsAppIcon />}
              href={`https://wa.me/${WA_NUMBER}?text=Hi!%20I%27m%20interested%20in%20the%20Negombo%20Day%20Tour`}
              target="_blank"
              rel="noreferrer"
